...
(cl:defmethod cl:initialize-instance :after ((m <Point2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messagefiles-msg:<Point2D> is deprecated: use messagefiles-msg:Point2D instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Point2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messagefiles-msg:x-val is deprecated.  Use messagefiles-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Point2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messagefiles-msg:y-val is deprecated.  Use messagefiles-msg:y instead.")
  (y m))
